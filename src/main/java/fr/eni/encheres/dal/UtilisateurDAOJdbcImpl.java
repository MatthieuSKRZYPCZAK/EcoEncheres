...
public class UtilisateurDAOJdbcImpl implements UtilisateurDAO {
	...
	/**
	 * Méthode permet à un utilisateur de se connecter en utilisant son adresse
	 * e-mail.
	 * 
	...
	public void deleteById(int noUtilisateur) {
		...
		try (Connection cnx = ConnectionProvider.getConnection()) {
			...
			pstmt.executeUpdate();
			System.out.println(
					"[UtilisateurDAOJdbcImpl:deleteById] L'utilisateur id : " + noUtilisateur + "a été supprimé");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	...
	/**
	 * Construit et retourne un Objet Utilisateur à partir des données d'un
	 * ResultSet
	 * 
	...
	/**
	 * Récupère et renvoie la liste de tous les utilisateurs depuis la base de
	 * donnée
	 * 
	 * @return Retourne une liste de tous les utilisateurs présents dans la base de
	 *         donnée
	 */
	@Override
