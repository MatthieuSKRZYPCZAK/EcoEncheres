...
public class EnchereManager {
	...
	public void enchere(Utilisateur utilisateur, Article article, int montantDeLEnchere) throws ArticleException {
		...
		if(encheres != null) {
			...
			refundPreviousBidder(encheres.getMontantEnchere(), lastBidder.getNoUtilisateur());
			placeBid(utilisateur.getNoUtilisateur(), article.getNoArticle(), (utilisateur.getCredit() - montantDeLEnchere));
		} else {
		...
		paidBid(utilisateur.getNoUtilisateur(), montantDeLEnchere);
		placeNewBid(utilisateur.getNoUtilisateur(), article.getNoArticle(), (utilisateur.getCredit() - montantDeLEnchere));
