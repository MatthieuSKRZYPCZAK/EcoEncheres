						...
						<div class="row justify-content-center">
							<div class="col-4 mt-3">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="prenom"  aria-label="prenom" aria-describedby="prenom" value="${sessionScope.isConnected.prenom}" placeholder="Prénom" required>
								</div>	
							</div>
							<div class="col-4 mt-3">
								<div class="input-group">
						...
						<div class="row justify-content-center">
							<div class="col-4 mt-3">
								<div class="input-group">
									...
									<input type="tel" class="form-control" name="telephone"  aria-label="telephone" aria-describedby="telephone" value="${sessionScope.isConnected.telephone}" minlength="10" maxlength="10" placeholder="Numéro de téléphone" required>
								</div>	
							</div>
							<div class="col-4 mt-3">
								<div class="input-group">
