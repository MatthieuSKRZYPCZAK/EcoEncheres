...
<body>
	...
	<main>
		...
		<c:choose>
			<c:when
				test="${not empty sessionScope.isConnected && sessionScope.isConnected.actif}">
				<c:choose>
								...
								<form action="vendre" method="post"
									...
									<div class="input-group">
										<span class="input-group-text" id="nomArticle">Nom de
											...
											aria-describedby="Nom article" value="${nomArticle}" required>
									</div>
									...
									<div class="input-group mt-3">
										<span class="input-group-text" id="prixInitial">Mise à
											...
											aria-describedby="Prix initial" value="${prixInitial}"
									...
									<fieldset class="rounded-3 border mt-3 p-3">
										...
										<div class="input-group mt-3">
											<span class="input-group-text" id="rue">Rue</span> <input
												...
												aria-describedby="Rue" value="${rue}" required>
										</div>
										<div class="input-group mt-3">
										...
										<div class="input-group mt-3">
											<span class="input-group-text" id="ville">Ville</span> <input
												...
												aria-label="Ville" aria-describedby="Ville" value="${ville}"
												required>
										</div>
									</fieldset>
									<div class="row justify-content-center">
										<div class="col-3 d-grid mt-3">
											<input class="btn btn-primary" type="submit" value="Vendre"
												id="submit">
										</div>
										<div class="col-3 d-grid mt-3">
			...
			<c:when test="${sessionScope.isConnected.actif eq false}">
				<span class="message">Votre compte est désactivé, vous ne
					pouvez pas vendre d'article</span>
