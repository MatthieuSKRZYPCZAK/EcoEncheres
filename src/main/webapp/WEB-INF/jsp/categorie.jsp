									...
									<div class="col-4 mt-1">
										<div class="input-group">
											<span class="input-group-text" id="categorie"><i
												class="bi bi-basket2"></i></span> <input type="tel"
												class="form-control" name="categorie" aria-label="categorie"
												aria-describedby="categorie" placeholder="nom de catégorie"
												required>
										</div>
									</div>
								</div>
								<div class="row justify-content-center">
									<div class="col-3 d-grid mt-1">
										<input class="btn btn-primary" type="submit"
											value="Créer une catégorie" id="submit">
									</div>
								</div>
							</form>
						</div>
						...
						<table
							...
							<c:forEach items="${listeCategories}" var="categorie">
								<tr>
									...
									<form
										action="<%=request.getContextPath()%>/modifierCategorie?id=${categorie.noCategorie}"
										method="post"
										onsubmit="return confirm('Êtes-vous sûr de vouloir modifier cette catégorie ?');">
										<td>
											<div class="col-sm-10">
												<input type="text" class="form-control form-control-sm"
													name="categorie" aria-label="Categorie"
													aria-describedby="Categorie" value="${categorie.libelle}"
										...
										<td class="text-center">
											<button class="btn btn-outline-*" type="submit">
												<img class="update-icon"
													src="${pageContext.request.contextPath}/img/construction.png"
													width="20" height="20" alt="icone modifier">
											</button>
										</td>
									</form>
									<td class="text-center"><a
										href="${pageContext.request.contextPath}/supprimerCategorie?id=${categorie.noCategorie}"
