...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %> 
	<title>ÉcoEnchères - Inscription</title>
</head>
<body>
				...
				<div class="row justify-content-center">
					<div class="col-4 mt-3">
						<div class="input-group">
							...
							<input type="password" class="form-control" pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@#$%^&+=!])(?!.*\s).{8,}$" name="motDePasse" aria-label="motDePasse" aria-describedby="motDePasse" value="${motDePasse}" placeholder="Mot de passe" title="Doit contenir au moins 8 caractères, dont au moins une majuscule, une minuscule, un chiffre et un caractère spécial" required>
						</div>
					</div>
					<div class="col-4 mt-3">
						<div class="input-group">
							<span class="input-group-text" id="confirmation"><i class="bi bi-check2-all"></i></span>
							<input type="password" class="form-control" name="confirmationMotDePasse" aria-label="confirmation" aria-describedby="confirmation" value="${confirmation}" placeholder="Confirmation du mot de passe"  required>
						</div>
					</div>
				</div>
				<div class="row justify-content-center">
